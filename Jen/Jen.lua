...
if not G.FUNCS.inc_omega_wheel then
  local function omega_step()
    local safe_isDown = (love and love.keyboard and type(love.keyboard.isDown) == 'function') and love.keyboard.isDown or
...
SMODS.current_mod.config_tab = function()
  ...
  return {
    ...
    nodes = {
      ...
      almanac_toggle('Skip Straddle Animation', 'straddle_skip_animation'),
