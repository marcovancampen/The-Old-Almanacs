LOVELY_INTEGRITY = 'a25771e461c2d7bca5c019fe0d6153460f2153b2661ec3aadb1029659a18ca94'
		...
		return {
			vars = {
				...
				colours = {
					...
					(
						lvcol('Four of a Kind')
					),
					(
						lvcol('Straight Flush')
					),
				},
			},
		}
